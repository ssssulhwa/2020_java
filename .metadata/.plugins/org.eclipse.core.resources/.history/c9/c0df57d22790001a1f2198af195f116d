...
public class Ex20 {
	public static void main(String[] args) {
		...
		// int k3가 1 또는 3은 남자, 2 또는 4는 여자, 나머지는 외국인
		int k3 = 1;
		res = (k3 == 1 || k3 == 3) ? "남자" : (k3 == 2 || k3 == 4) ? "여자" : "외국인";
		System.out.println("결과 : " + res);

		// int k4가 1 또는 3은 남자, 2 또는 4는 여자, 나머지는 외국인
		// 1 또는 2이면 1900년대 생, 3또는 4이면 2000년대 생
		// ? 앞은 조건, ? 뒤는 참
		int k4 = 1 ;
		res = (k4 == 1 || k4 == 3)?((k4==1)? "1990년 태어난 남자" :"2000년대 태어난 남자" ) :
